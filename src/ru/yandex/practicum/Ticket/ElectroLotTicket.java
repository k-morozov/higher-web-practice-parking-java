...
public class ElectroLotTicket implements Ticket {
    private final int ticketID;
    private final int pos;
    private final String number;

    public ElectroLotTicket(int pos, String number) {
    ...
    public Result<Void> leave(ManagerProvider provider){
        return provider.getElectroLotsOperator().leave(this);
    }

    @Override
    public String toString() {
        return "ElectroLotTicket[ticket_id=" + ticketID + ", pos=" + pos + ", car number=" + number + "]";
    }
}
